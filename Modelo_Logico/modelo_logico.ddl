...
ALTER TABLE modifica ADD CONSTRAINT modifica_PK PRIMARY KEY (Trabajador_dni, Partes_id_parte);
...
ALTER TABLE Partes ADD CONSTRAINT Partes_Trabajador_FK FOREIGN KEY (Trabajador_dni)
...
ALTER TABLE Cerrados ADD CONSTRAINT Cerrados_Trabajador_FK FOREIGN KEY (Trabajador_dni)
REFERENCES Trabajador (dni) ON DELETE CASCADE;
...
INSERT INTO Login VALUES ('aritzGM', '11111111A');
INSERT INTO Login VALUES ('amaiaGP', '22222222B');
INSERT INTO Login VALUES ('jonFL', '33333333C');
INSERT INTO Login VALUES ('aneAS','44444444D');
INSERT INTO Login VALUES ('markelMR','55555555E');
INSERT INTO Login VALUES ('naiaAG','66666666F');
INSERT INTO Login VALUES ('nicolasMC','77777777G');
INSERT INTO Login VALUES ('leireMB','88888888H');
INSERT INTO Login VALUES ('aimarCB','99999999I');
INSERT INTO Login VALUES ('hodeiQP','00000000J');
